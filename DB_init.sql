...
CREATE TABLE NOLEGGIO(
    ...
    FOREIGN KEY (ID_ACCESSORIO_OBBLIGATORIO) REFERENCES ACCESORIO_OBBLIGATORIO(ID_ACCESSORIO_OBBLIGATORIO) ON DELETE CASCADE
);
...
CREATE TABLE NOLEGGIO_ACCESSORIO_OPTIONAL (
    ...
    FOREIGN KEY (ID_CLIENTE) REFERENCES CLIENTE_REGISTRATO(ID_CLIENTE) ON DELETE CASCADE,
    FOREIGN KEY (ID_ACCESSORIO_OPTIONAL) REFERENCES ACCESORIO_OPTIONAL(ID_ACCESSORIO_OPTIONAL) ON DELETE CASCADE
